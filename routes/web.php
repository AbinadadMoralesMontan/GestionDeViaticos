...
Route::middleware('auth')->group(function () {
    ...
    // Grupo que permite múltiples roles: rectoria y empleado
    Route::middleware('role:rectoria,empleado')->group(function () {
    ...
    // Grupo específico para rectoria
    Route::middleware('role:rectoria')->group(function () {
    ...
    Route::middleware('role:fiscalizacion,rectoria')->group(function () {
    ...
    Route::middleware('role:tesoreria,rectoria')->group(function () {
